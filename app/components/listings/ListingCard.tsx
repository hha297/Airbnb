                ...
                <div className="col-span-1 cursor-pointer group" onClick={() => router.push(`/listings/${data.id}`)}>
                        <div className="flex flex-col gap-2 w-full">
                                <div className="aspect-square w-full relative overflow-hidden rounded-xl">
                                        <Image src={data.imageSrc} fill className="object-cover w-full h-full group-hover:scale-110 transition" alt="Listing" />
                                ...
                                {onAction && actionLabel && <Button onClick={handleCancel} disabled={disabled} small label={actionLabel} />}
                        </div>
                </div>
        );
};
