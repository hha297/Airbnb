...
const SearchModal = () => {
        ...
        const onSubmit = useCallback(async () => {
                ...
                searchModal.onClose();
                router.push(url);
        }, [step, searchModal, params, location, guestCount, roomCount, bathroomCount, dateRange, router, onNext]);
        ...
        if (step === STEPS.INFO) {
                bodyContent = (
                        <div className="flex flex-col gap-8">
                                ...
                                <Counter title="Guests" subtitle="How many guests are coming?" onChange={(value) => setGuestCount(value)} value={guestCount} />
